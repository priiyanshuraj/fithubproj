...
import { C as useQueryClient, z as onlineManager } from "./modern-Dsfv2rNq.js";
import { I as mergeProps, P as lazy, V as render, W as setupStyleSheet, m as createComponent, x as createSignal } from "./6FXOYLZD-XjCJFjnB.js";
//#region ../node_modules/.pnpm/@tanstack+query-devtools@5.93.0/node_modules/@tanstack/query-devtools/build/dev.js
	...
	mount(el) {
		...
		const dispose = render(() => {
			...
			if (this.#Component) Devtools = this.#Component;
				...
				Devtools = lazy(() => import("./B5PP2USH-jTtTHfew.js"));
	...
	mount(el) {
		...
		const dispose = render(() => {
			...
			if (this.#Component) Devtools = this.#Component;
				...
				Devtools = lazy(() => import("./WI32IQVE-CEL54uCK.js"));
				this.#Component = Devtools;
			}
			setupStyleSheet(this.#styleNonce, this.#shadowDOMTarget);
			return createComponent(Devtools, mergeProps({
...
//#endregion
//#region ../node_modules/.pnpm/@tanstack+react-query-devtools@5.91.3_@tanstack+react-query@5.90.21_react@19.2.4__react@19.2.4/node_modules/@tanstack/react-query-devtools/build/modern/ReactQueryDevtools.js
...
//#endregion
//#region ../node_modules/.pnpm/@tanstack+react-query-devtools@5.91.3_@tanstack+react-query@5.90.21_react@19.2.4__react@19.2.4/node_modules/@tanstack/react-query-devtools/build/modern/ReactQueryDevtoolsPanel.js
...
//#endregion
//#region ../node_modules/.pnpm/@tanstack+react-query-devtools@5.91.3_@tanstack+react-query@5.90.21_react@19.2.4__react@19.2.4/node_modules/@tanstack/react-query-devtools/build/modern/index.js
